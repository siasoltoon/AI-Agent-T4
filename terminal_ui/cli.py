...
def render(event: str, data: dict) -> None:
    ...
    elif event == "model_retry": console.print(f"[bold magenta][MODEL-RETRY][/bold magenta] Attempt {data['attempt']}/{data['max']}: {data['error']}")
